...
# 	Adform.hype-export.py
#		Export Script for Adform
#
...
defaults_bundle_identifier = "com.tumult.Hype2.hype-export.Adform"
...
def main():
	...
	if args.get_options:		
		...
		def extra_actions():
			return [
				{"label" : "Click Tag 1", "function" : "clickTag1"},
			]
	...
	##				arguments: array of strings	elif args.modify_staging_path != None:
		...
		# add in method to include width/height into insert_at_head_start variable
		global insert_at_head_start
		template = string.Template(insert_at_head_start)

		insert_at_head_start = template.substitute({'width' : export_info['main_container_width'], 'height' : export_info['main_container_height'], "clickTag1" : clickTag1 })
		
		if "clickTag1" in export_info["document_arguments"]:
			clickTag1 = export_info["document_arguments"]["clickTag1"]
		else:
			clickTag1 = ""
